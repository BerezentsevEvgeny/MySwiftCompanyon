...
// - Вью модель подписывается по протокол ObservableOnject
// - свойства вью модели за которыми следим обернуть в @Published
// - Экземпляр вью модели во вьюконтроллере обернуть в @StateObject - работает со ссылочными типами (@State со значимыми)
