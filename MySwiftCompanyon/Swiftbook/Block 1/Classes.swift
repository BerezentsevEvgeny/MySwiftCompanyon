...
//   - Свойства предпочтительно приватные - делаются публичными только по необходимости
...
// Чтобы иметь возможность переопределять наследуемые свойства они должны быть вычисляемыми то есть геттерами
